            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <div class="card-title">Sewa Mobil</div>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <form action="mobils-rent" method="POST">
                                @csrf
                                ...
                                <div class="form-group">
                                    <label>Tanggal Kembali Mobil</label>
                                    <input type="date" name="return_date" class="form-control" id="date"/>
                                </div>
